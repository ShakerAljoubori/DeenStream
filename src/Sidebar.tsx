  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-20 flex flex-col items-center py-6 bg-app-card border-r border-white/5 z-60">
      ...
      <div className="flex flex-col gap-6 text-text-muted">
        ...
        {/* Home */}
        <div className="p-3 group hover:bg-brand-primary/10 rounded-xl transition-all cursor-pointer">
          <HiOutlineHome className="text-2xl group-hover:text-brand-primary transition-colors" />
        </div>
        ...
        {/* Audio Content */}
        <div className="p-3 group hover:bg-brand-primary/10 rounded-xl transition-all cursor-pointer">
          <IoHeadsetOutline className="text-2xl group-hover:text-brand-primary transition-colors" />
        </div>
