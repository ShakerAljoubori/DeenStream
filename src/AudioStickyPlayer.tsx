...
const AudioStickyPlayer = () => {
  ...
  return (
    <div className="fixed bottom-16 md:bottom-0 left-0 right-0 h-20 px-4 flex items-center justify-between z-[100] backdrop-blur-md" style={{ background: "linear-gradient(180deg, #111a14 0%, #0d0d0d 100%)", borderTop: "1px solid rgba(22,196,127,0.2)" }}>
